document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Click event for the seed and play background audio
    ...
    soundControl.addEventListener("input", (e) => {
    ...
    speedControl.addEventListener("input", () => {
      ...
      sleep = (ms) => new Promise((resolve) => setTimeout(resolve, ms / speed));
    });
  
    // Custom background image change on click
    canvas.addEventListener("click", (e) => {
      canvas.parentNode.style.backgroundImage = "url('path/to/your/new/image.jpg')";
      canvas.parentNode.style.backgroundSize = "cover";
      canvas.parentNode.style.backgroundRepeat = "no-repeat";
    });
    ...
    // Call the animation functions in sequence
    await seedAnimate();
    await growAnimate();
    await flowAnimate();
    await moveAnimate();
